...
const footerNavigation = {
  features: [
    { name: 'Todo Management', href: '/dashboard' },
    { name: 'Filtering', href: '/dashboard' },
    { name: 'Mobile UI', href: '/dashboard' },
    { name: 'Dashboard', href: '/dashboard' },
  ],
  links: [
    { name: 'Dashboard', href: '/dashboard' },
        ...
        <div className="relative -z-10 mt-32 px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg/8 text-pretty text-gray-600">
              Manage your todos efficiently and stay organized with our easy-to-use interface.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="/register"
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm/6 font-semibold text-gray-900">Features</h3>
